 ...
 * @author marcos
 */
public class CartasCorreioTableModel extends javax.swing.table.AbstractTableModel{

    private List<Carta> cartas;
    private String[] colunas;

    public CartasCorreioTableModel() {
        cartas= new ArrayList<>();
        this.colunas = new String[] { "NOME", "VALOR"};
    }

    
    public CartasCorreioTableModel(List cartas) {
        this.cartas = cartas;
        this.colunas = new String[] {"NOME", "VALOR"};
    }
